...
var appRoutes = [
    ...
    { path: 'room/:roomId', component: __WEBPACK_IMPORTED_MODULE_5__components_game_game_play_game_play_component__["a" /* GamePlayComponent */] },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_game_model_client__ = __webpack_require__("../../../../../src/app/models/game.model.client.ts");
...
var GamePlayComponent = /** @class */ (function () {
    function GamePlayComponent(userService, gameService, roomService, cardService, activatedRoute, router) {
        var _this = this;
        this.userService = userService;
        this.gameService = gameService;
        this.roomService = roomService;
        ...
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.game = new __WEBPACK_IMPORTED_MODULE_2__models_game_model_client__["a" /* Game */](Math.floor(Math.random() * 100), this.user);
    ...
    GamePlayComponent.prototype.ngOnInit = function () {
        ...
        this.socket = __WEBPACK_IMPORTED_MODULE_7_socket_io_client__();
    ...
    GamePlayComponent.prototype.startGame = function () {
        this.started = true;
    };
