            ...
            if(!err){
                ...
                for(i = 0; i < NUM_CARDS; i++) {
                    if(i < 5){
                        ...
                        cardModel.create({id: i, type: 'Salmon'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    } else if(i < 20){
                        cardModel.create({id: i, type: 'Squid'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    } else if(i < 26){
                        cardModel.create({id: i, type: 'Maki_1'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    } else if(i < 38){
                        cardModel.create({id: i, type: 'Maki_2'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    } else if(i < 46){
                        cardModel.create({id: i, type: 'Maki_3'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    } else if(i < 60){
                        cardModel.create({id: i, type: 'Tempura'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    } else if(i < 74){
                        cardModel.create({id: i, type: 'Sashimi'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    } else if(i < 88){
                        cardModel.create({id: i, type: 'Dumpling'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    } else if(i < 94){
                        cardModel.create({id: i, type: 'Chopsticks'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    } else if(i < 98){
                        cardModel.create({id: i, type: 'Wasabi'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    } else if(i < 108){
                        cardModel.create({id: i, type: 'Pudding'}, function (err, res) {
                            if(!err) console.log(res.type + ' created!');
                            else return err;
                        });
                    }
